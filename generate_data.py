...
def addition_task(n_train, n_test, T):
    "Generate data from the addition task. Arguments: T (sequence length), n (data size)"
    # Train data
...
def copy_task(n_train, n_test, T):
    "Generate data from the copy task. Arguments: "
    # Train data
...
def mnist_task():
    "Generate data from the pixel-by-pixel MNIST task"
